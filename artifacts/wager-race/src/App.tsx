        ...
        <section className="py-10 px-4">
          <div className="container mx-auto max-w-3xl flex gap-4 justify-center">
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-between bg-card border border-primary/20 rounded-2xl p-8 hover:border-primary/60 hover:shadow-[0_0_30px_rgba(236,72,153,0.12)] transition-all cursor-pointer group w-[340px] h-[340px] overflow-hidden shrink-0"
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-center bg-card/20 border border-border/20 rounded-2xl p-8 opacity-40 cursor-not-allowed select-none w-[340px] h-[340px] overflow-hidden shrink-0"
            >
