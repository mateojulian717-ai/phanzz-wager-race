        ...
        <section className="py-10 px-4">
          <div className="container mx-auto max-w-3xl flex gap-4 justify-center">
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-between bg-card border border-primary/20 rounded-2xl p-8 hover:border-primary/60 hover:shadow-[0_0_30px_rgba(236,72,153,0.12)] transition-all cursor-pointer group w-[300px] h-[300px] overflow-hidden shrink-0"
              onClick={onViewLeaderboard}
              data-testid="button-view-leaderboard"
            >
              <img src="/gamba-logo.png" alt="Gamba" className="w-full max-w-[120px] object-contain" />
            ...
            <motion.div
              ...
              className="flex flex-col items-center justify-center bg-card/20 border border-border/20 rounded-2xl p-8 opacity-40 cursor-not-allowed select-none w-[300px] h-[300px] overflow-hidden shrink-0"
            >
